...
class dondathangcontroller extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return response()->json(['message' => 'Dữ liệu được cập nhật thành công']);
        } catch (\Exception $e) {
            return response()->json(['message' => 'Lỗi cập nhật dữ liệu'], 500);
        }
    }
    ...
    public function tracuudon(Request $request){
        $sdt = $request['sdt'];
        $dondathang = dondathang::where('sdt', $sdt)->get();
        return response()->json($dondathang);
    }
