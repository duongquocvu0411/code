...
Route::get('danh-muc-san-pham/{type}',['as'=>'danhmucsp','uses'=>'PageController@getDanhmucSp']);

Route::get('danh-muc-san-pham-hang/{type}',['as'=>'danhmucsphang','uses'=>'PageController@getDanhmucSpHang']);

Route::get('danh-muc-san-pham-hangsx/{type}',['as'=>'danhmuchsx','uses'=>'PageController@getDanhmucSpHsx']);

Route::get('chi-tiet-san-pham/{id}',['as'=>'chitietsanpham','uses'=>'PageController@getChitiet']);

Route::post('chi-tiet-san-pham/{id}',['as'=>'chitietsanpham','uses'=>'PageController@postComment']);

Route::get('san-pham-moi',['as'=>'sp_new','uses'=>'PageController@getSpNew']);

Route::get('san-pham-giam-gia',['as'=>'sp_sale','uses'=>'PageController@getSpSale']);
...
Route::get('tin-tuc',['as'=>'tintuc','uses'=>'PageController@getNews']);

Route::get('chi-tiet-tin/{id}',['as'=>'chitiettin','uses'=>'PageController@getChitietNews']);
...
Route::get('Save-Item-List-Cart/{id}/{qty}',['as'=>'capnhatgiohang','uses'=>'PageController@getUpdateItemCart']);
...
Route::get('dang-ky',['as'=>'sigin','uses'=>'PageController@getSigin']);

Route::post('dang-ky',['as'=>'sigin','uses'=>'PageController@postSigin']);
...
Route::group(['prefix'=>'admin','middleware'=>'admin'],function(){
	Route::group(['prefix'=>'layout'],function(){
		...
		Route::get('edit/{id}','SupplierController@getEdit');
		Route::post('edit/{id}','SupplierController@postEdit');
